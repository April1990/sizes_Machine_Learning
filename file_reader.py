...
df_female = pd.read_csv('csv/female.csv')
df_male = pd.read_csv('csv/male.csv')
...
def female_top_clothing():
    f_tshirts = ["waistcircumference", "waistdepth", "waistfrontlengthsitting", "acromialheight",
                 ...
                 "neckcircumferencebase", "suprasternaleheight", "Heightin", "weightkg"]
...
def female_bottom_clothing():
    f_shorts = ["iliocristaleheight", "kneeheightmidpatella", "kneeheightsitting", "lowerthighcircumference",
                "poplitealheight", "thighcircumference", "thighclearance", "tibialheight", "waistheightomphalion", "Heightin", "weightkg"]
